...
import { ChartIcon, FileIcon, GridIcon, HeadphonesIcon, PencilIcon, UserIcon, XIcon } from "./Icons";
...
const primaryItems = [
  ...
  { label: "Notes & PDFs", href: "/student/notes", icon: FileIcon },
  { label: "Quizzes", href: "/student/quizzes", icon: PencilIcon },
  { label: "Results", href: "/student/results", icon: ChartIcon },
];
    ...
    <nav className="flex flex-1 flex-col" aria-label="Student navigation">
      <div className="space-y-1.5">
        {primaryItems.map((item) => {
          ...
          const active = item.href === "/student/notes" ? pathname.startsWith("/student/notes") : pathname === item.href;
